...
public class Home extends ViewFrame {
    ...
    private Component createContent() {
        ...
        final Html intro = new Html("<p>A responsive application template with some dummy data. Loosely based on "
        ...
        final Html productivity = new Html("<p>The starter gives you a productivity boost and a head start. "
        ...
        final Html features = new Html("<p>The app comes with multiple list views to edit master-detail data. "
        ...
        final Anchor documentation = new Anchor("https://vaadin.com/docs/business-app/overview.html",
                UIUtils.createButton("Read the documentation", VaadinIcon.EXTERNAL_LINK));
        final Anchor starter = new Anchor("https://vaadin.com/start/latest/business-app",
                UIUtils.createButton("Start a new project with Business App", VaadinIcon.EXTERNAL_LINK));

        final FlexBoxLayout links = new FlexBoxLayout(documentation, starter);
        links.setFlexWrap(FlexWrap.WRAP);
        links.setSpacing(Right.S);

        final FlexBoxLayout content = new FlexBoxLayout(intro, productivity, features, links);
